...
// Entry operations
export async function getAllEntries(babyId) {
...
export async function getEntriesByDateRange(babyId, startDate, endDate) {
    const dbEntries = await db.entries
        .where('babyId')
        .equals(babyId)
        .and(entry => {
...
// Utility functions
export async function getLatestEntry(babyId) {
    const dbEntries = await db.entries
        .where('babyId')
        .equals(babyId)
        .toArray();
...
export async function getActiveSleepEntry(babyId) {
    const dbEntries = await db.entries
        .where('babyId')
        .equals(babyId)
